...
namespace mobileBackendsoftFount.Models
{
        public class OilBuyReceipt
    {
        ...
        public int? OilAccountBalanceId { get; set; } // Foreign Key (nullable at first)
        [ForeignKey("OilAccountBalanceId")]
        public oilAccountBalance OilAccountBalance { get; set; } // Navigation Property
    }
